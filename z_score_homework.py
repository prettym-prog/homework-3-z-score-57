...
def test_z_score_function():
    ...
    print("Z-score of mean (population3):", z_score(pop3_avg, pop3_avg, pop3_sd))

    # Additional Test Case 2
    pop2_least = least(population2)
    z_least = z_score(pop2_least, pop2_avg, pop2_sd)
    print("Sum of least and greatest z-scores (population2):", z_least + greatest_z_score_p2)
...
def z_score(x, mu, sigma):
    ...
    # Participating group member names:
    # Mikyra Pretty
    # Paul Price
    # Hailey Preston
